...
const Logo = () => {
  ...
  useEffect(() => {
    ...
    const tl = gsap.timeline({ ease: 'back' })
    const earPath = MorphSVGPlugin.convertToPath('#ear')
    ...
    let anim = tl
      ...
      .to(earPath, { x: -150, y: 0, duration: 0.75 }, 'anim')
      .to(
        bottomEye.current,
        {
          morphSVG: topEye.current,
      ...
      .to(earPath, { x: -90, y: -80, duration: 0.75 }, 'anim2')
      .to(
        bottomEye.current,
        {
          morphSVG: bottomEye.current,
      ...
      .to(earPath, { x: 0, y: 0, duration: 0.75 }, 'anim3')
    tl.pause()
    setTween(anim)
  }, [])
